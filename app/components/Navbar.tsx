...
export default function Navbar() {
  ...
  useEffect(() => {
    // Check if the page was reloaded with a hash and redirect to `/` if it was
      ...
      <header className="fixed w-full z-50">
        <nav className="bg-white shadow-lg py-6 dark:bg-gray-900">
          <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            >
              <span className="self-center text-4xl font-semibold whitespace-nowrap text-teal-500">
                Ammar
              </span>
            </a>
            ...
            <div
              className={`items-center justify-between ${
                isMobileMenuOpen ? "block slide-down" : "hidden"
